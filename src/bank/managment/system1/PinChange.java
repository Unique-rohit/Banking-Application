...
public class PinChange extends JFrame  implements ActionListener{
    ...
    PinChange(String pinnumber){
        ...
        text.setBounds(279,400,700,35);
        image.add(text);
        
        JLabel pintext = new JLabel("New PIN");
        pintext.setForeground(Color.black);
        pintext.setFont(new Font("System",Font.BOLD,16));
        pintext.setBounds(279,420,700,35);
        image.add(pintext);
        
        pin = new JPasswordField();
        pin.setFont(new Font("Raleway",Font.BOLD,25));
        pin.setBounds(370, 430, 100, 22);
        image.add(pin);
        
        JLabel repintext = new JLabel(" Re-enter New PIN");
        repintext.setForeground(Color.black);
        repintext.setFont(new Font("System",Font.BOLD,16));
        repintext.setBounds(275,450,700,35);
        image.add(repintext);
        
        repin = new JPasswordField();
        repin.setFont(new Font("Raleway",Font.BOLD,25));
        repin.setBounds(413, 458, 90, 22);
        image.add(repin);
